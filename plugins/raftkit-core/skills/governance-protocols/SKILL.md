...
**Owner:** Ashit, by PR to this file set. Raised on Asana task `1216383018361190`. Until he rules: the payload ships exactly as written, no skill selects a model programmatically at run time, and the binding stays out. If he confirms the permissive reading, the Gate 1 binding can land as a follow-up.
