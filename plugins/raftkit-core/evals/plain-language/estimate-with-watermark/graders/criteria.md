...
2. Each estimate line names the AC/scenario it covers, a low-high hour range,
   and its assumption in plain words — not a wall of unexplained
   abbreviations.
3. No sentence in the surrounding prose (outside the watermark and the
   estimate table itself) exceeds ~25 words, and none of the banned filler
