...
1. **Template fetched live this run.** The transcript shows the Feature Template task (GID `<Feature Template GID>`) being read from Asana during this session, before the story body is drafted. The draft's structure demonstrably follows what was fetched.
