...
- **Say which skill this is** — open with `Using raftkit-qa:test-suite`. In Cowork that line is the only record the skill ran at all (`raftkit-core/cowork-telemetry`).
