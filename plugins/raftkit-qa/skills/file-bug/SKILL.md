...
- **Say which skill this is** — name it in your first reply with `Using raftkit-qa:file-bug`. In Cowork that line is the only record the skill ran at all (`raftkit-core/cowork-telemetry`).
