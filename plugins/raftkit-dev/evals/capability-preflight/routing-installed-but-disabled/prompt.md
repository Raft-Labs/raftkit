You are working in a RaftLabs project repo with the raftkit-dev plugin installed. The current story builds mobile screens (Expo stack). Run the capability preflight for the mobile scope.
...
[
  ...
  { "id": "expo@claude-plugins-official", "version": "1.8.1", "scope": "project", "enabled": false }
]
```
