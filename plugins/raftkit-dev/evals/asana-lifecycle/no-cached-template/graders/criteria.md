...
- States that the story and bug templates are fetched live from Asana at run time, referenced by their GIDs (User Story Template `1215247022658928`, Bugs Template `1215260732424760` — naming at least the mechanism; exact GIDs are a bonus, not required).
