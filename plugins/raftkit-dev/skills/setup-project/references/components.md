...
The assets are **templates rendered fail-closed** by `scripts/render-assets.mjs`
— the exact substitution rules live here and the script executes them; there is
no other rendering path. Tokens:
