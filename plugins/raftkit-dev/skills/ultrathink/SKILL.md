...
skill plans; it does not execute the plan, modify files, write to Asana, install
providers, publish, deploy, or spend.
...
- Do not execute, install, write, send, merge, deploy, or spend from this skill.
